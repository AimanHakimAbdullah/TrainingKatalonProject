...
WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/input_Date of Birth_dateOfBirthInput'), '03 May 2023')
...
WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/textarea_Current Address_currentAddress'), 'Kg Dekat atas dunia')

WebUI.click(findTestObject('Object Repository/Page_DEMOQA/div_option NCR focused, 1 of 4. 4 results a_c0b78b'))
